...
namespace DDOLogAnalyzer.Helpers
{
    ...
    public class EnglishParser 
    {
        ...
        public bool SplitTargetAbility(Damage damage)
        {
            ...
            {
                string target = damage.Target.Substring(0, idx);
                string targetability = damage.Target.Substring(idx + 2).Trim();
                if (target != "")
                {
            ...
            {
                string source = damage.Source.Substring(0, idx);
                string sourceability = damage.Source.Substring(idx + 2).Trim();
                if (source != "")
                {
